...
fun UbiqueWebView(
	...
	client: UbiqueWebViewClient = remember { UbiqueWebViewClient() },
	chromeClient: UbiqueWebChromeClient = remember { UbiqueWebChromeClient() },
 ...
 *
 * A parent class of WebViewClient that an be subclassed for custom behaviour
 */

open class UbiqueWebViewClient : WebViewClient() {
	...
	override fun onPageFinished(view: WebView, url: String?) {
		...
		// Replace [FONT] placeholders in any page with an asset URL to our font asset
		// Check the ETHWebViewClient for the code that actually loads the asset
...
open class UbiqueWebChromeClient : WebChromeClient() {
	open lateinit var state: WebViewState
		internal set
